...
func TestNexposeAssetProducerHandler(t *testing.T) {
	...
	mockAssetValidator.EXPECT().ValidateAssets(gomock.Any(), assetList, "1", gomock.Any(), gomock.Any()).Return(validAssetList, []error{})
...
func TestNexposeAssetProducerHandlerMultipleAssets(t *testing.T) {
	...
	mockAssetValidator.EXPECT().ValidateAssets(gomock.Any(), assetList, scanID, gomock.Any(), gomock.Any()).Return(validAssetList, []error{})
...
func TestNexposeAssetProducerHandlerMultipleErrors(t *testing.T) {
	...
	mockAssetFetcher.EXPECT().FetchAssets(gomock.Any(), "12345").Return(assetList, nil)
	mockAssetValidator.EXPECT().ValidateAssets(gomock.Any(), assetList, scanID, gomock.Any(), gomock.Any()).Return(validAssetList, errorList)
